...
inline fun Expression.lessThan(date: Date) = lessThan(Expression.date(date))
...
inline fun Expression.lessThanOrEqualTo(date: Date) = lessThanOrEqualTo(Expression.date(date))
...
inline fun Expression.greaterThanOrEqualTo(date: Date) = greaterThanOrEqualTo(Expression.date(date))
...
inline fun Expression.equalTo(date: Date) = equalTo(Expression.date(date))
...
inline fun Expression.notEqualTo(date: Date) = notEqualTo(Expression.date(date))
...
inline fun Expression.like(date: Date) = like(Expression.date(date))
...
class WhereBuilder {
    ...
    inline infix fun String.lessThan(date: Date) = property(this).lessThan(date)
    ...
    inline infix fun String.lessThanOrEqualTo(date: Date) = property(this).lessThanOrEqualTo(date)
    ...
    inline infix fun String.greaterThan(date: Date) = property(this).greaterThan(date)
    ...
    inline infix fun String.greaterThanOrEqualTo(date: Date) = property(this).greaterThanOrEqualTo(date)
    ...
    inline infix fun String.equalTo(date: Date) = property(this).equalTo(date)
    ...
    inline infix fun String.notEqualTo(date: Date) = property(this).notEqualTo(date)
    ...
    inline infix fun String.like(date: Date) = property(this).like(date)
}
